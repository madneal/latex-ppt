...
\begin{document}
\begin{CJK*}{GBK}{song}
%p\captionsetup[figure]{labelfont={bf},labelformat={default},labelsep=period,name={图.}}
...
%    \begin{column}{0.7\textwidth}
    ...
    \begin{columns}
    \begin{column}{0.6\textwidth}
    \subfigure[F7]{\includegraphics[ width=0.25\textwidth]{f7_igd.eps}}
    \subfigure[F8]{\includegraphics[ width=0.25\textwidth]{f8_igd.eps}}
